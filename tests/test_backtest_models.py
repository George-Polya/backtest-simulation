...
from backend.models.backtest import AVAILABLE_DATA_END
...
class TestLLMSettings:
    ...
    def test_default_values(self) -> None:
        """Test default LLMSettings values."""
    ...
    def test_custom_values(self) -> None:
        """Test custom LLMSettings values."""
        settings = LLMSettings(
...
class TestBacktestParams:
    ...
    def test_full_params(self, valid_params: dict) -> None:
        ...
        valid_params.update({
            ...
            "llm_settings": LLMSettings(web_search_enabled=True),
        })
        params = BacktestParams(**valid_params)
        ...
        assert params.llm_settings.web_search_enabled is True
    ...
    def test_default_values(self, valid_params: dict) -> None:
        ...
        assert params.llm_settings.web_search_enabled is False
