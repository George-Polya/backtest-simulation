...
class GenerationConfig:
    ...
    When temperature is None, the provider uses its own configured default
    (e.g., from config.yaml). When explicitly set, it overrides the provider default.

    Attributes:
        temperature: Sampling temperature (0.0 = deterministic, 2.0 = creative).
                     None means use the provider's configured default.
